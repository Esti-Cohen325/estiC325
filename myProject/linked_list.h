...
/*-------------------------------------------free----------------------------------------------------*/
/*
methods that responsible for freeing the memory that has been allocated for the list each free function will free each part of the list and in the end will send the list to a freeList funcrion
*/
...
/*
this function chackes if threr is a macro name and if so the function prints to the file the macro command insted of the macro name and if not the function return 0=fals*
...
/*
the function checs if its an instruction of ".data" or ".string" command and if so the function sends to "insertInstruction" function to insert into instruction list the data
*/
...
/*
this function sends the all the instruction data that we need to print(strings or intigers data) to a print_bynary function that the printings into print_list that will be printing in the end of the program
*/
